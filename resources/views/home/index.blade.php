...
<div class="container">
    ...
    <div class="row">
                <form>
                    <div class="form-group">
                        <label for="inputcodigo" class="col-lg-1 col-md-1 col-sm-1 control-label text-center letra150 margen-superior margen-derecho margen-izquierdo">Código</label>
                        <div class="col-lg-9 col-md-9 col-sm-7 col-lg-offset-0 col-md-offset-0 col-sm-offset-1 margen-superior">
                            <input type="text" id="inputcodigo" class="form-control" placeholder="Ingresa aquí el código">
                        </div> 
                        <div class="col-lg-1 col-md-1 col-sm-1">
                            <button type="submit" class="btn btn-default margen-izquierdo margen-superior text-center">Agregar</button>
                        </div>   
                    </div>
                </form>
    </div>
    ...
    <div class="row margen-superior">
        <div class="col-lg-4 col-md-4 col-sm-4 margen-superior">
